...
const EmailVerificationPage = () => {
    ...
    const { verifyEmail, isLoading, error, clearError } = authStore();
    ...
    // ลบตัวเลขเมื่อกด Backspace และโฟกัสช่องก่อนหน้า
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(`Verification code sumbitted ${verificationCode}`);
